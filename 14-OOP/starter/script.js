...
class PersonCl {
  ...
  class StudentCl extends PersonCl {
    constructor(fullName, birthYear, course) {
        // Always need to happen first! (creates the 'this' keyword)
        super(fullName, birthYear) // constructor
        this.course = course;
    }
  ...
  const martha = new StudentCl('Martha Jones', 2020, 'Medicine');
  console.log(martha);
  martha.introduce();
  martha.calcAge();
  */
...
class Account {
    ...
    constructor(owner, currency, pin) {
        ...
        // protected properties (underscore as a convention for protected properties)
        this.#pin = pin;

        // Moved to private fields above 
        // this._movements = [];

        // Moved to public fields above 
    ...
    // static methods will work only for this class, not for class instances
    static helper() {
        console.log('Helper');
    }

    // 4) Private methods
    // #approveLoan(val) { (syntax on approval stage for private methods)
    _approveLoan(val) {
        return true;
    }
}
...
// Can't access a private field (Uncaught SyntaxError: Private field '#movements' must be declared in an enclosing class)
// console.log(acc1.#movements);
// console.log(acc1.#pin);

Account.helper();
// acc1.helper(); Uncaught TypeError: acc1.helper is not a function at script.js:602
